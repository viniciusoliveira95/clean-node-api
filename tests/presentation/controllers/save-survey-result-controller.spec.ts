import { HttpRequest, LoadSurveyById, SaveSurveyResult } from '../../../src/presentation/controllers/survey-result/save-survey-result/save-survey-result-controller-protocols'
...
describe('SaveSurveyResultController', () => {
  ...
  test('Should call SaveSurveyResult with correct values', async () => {
    ...
    const saveSpay = jest.spyOn(saveSurveyResultStub, 'save')
    await sut.handle(mockRequest())
    expect(saveSpay).toHaveBeenCalledWith({
      surveyId: 'any_survey_id',
      accountId: 'any_account_id',
      date: new Date(),
      answer: 'any_answer'
