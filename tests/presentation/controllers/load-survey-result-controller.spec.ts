import { HttpRequest, LoadSurveyById, LoadSurveyResult } from '../../../src/presentation/controllers/survey-result/load-survey-result/load-survey-result-controller-protocols'
